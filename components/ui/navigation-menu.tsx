...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 flex max-w-max flex-1 items-center justify-center tracking-wide",
      className
    )}
    {...props}
  >
...
const navigationMenuTriggerStyle = cva(
  "group/navTrig inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-xl font-medium transition-colors disabled:pointer-events-none disabled:opacity-50"
);
