          ...
          <NavigationMenu>
            <NavigationMenuList className="gap-1">
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr] bg-risu-300 rounded-md shadow-lg">
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] bg-risu-300 rounded-md shadow-lg">
