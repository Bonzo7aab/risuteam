      ...
      <div className="md:my-8 divide-y divide-risu-400 text-lg leading-relaxed">
        <div className="flex items-center mx-auto sm:flex-row flex-col py-16">
          ...
          <div className="mx-8 mt-8">
            ...
            <p className="text-justify flex-grow sm:text-left mt-6 sm:mt-0">
              Karate to tradycyjna japońska sztuka walki oparta na precyzyjnych
              ciosach, kopnięciach i blokach. Styl walki w karate łączy
              szybkość, równowagę oraz kontrolę nad własnym ciałem. Techniki
              wykonuje się z dużą dyscypliną, co minimalizuje ryzyko kontuzji.
              Trening obejmuje kata – ustalone sekwencje ruchów – oraz kumite,
              czyli walkę z przeciwnikiem. Karate ma charakter defensywny, a
              jedną z podstawowych zasad jest nieatakowanie jako pierwszy. Styl
              walki kształtuje nie tylko ciało, ale też charakter i
              samodyscyplinę. Karatecy rozwijają refleks, siłę oraz odporność
              psychiczną. To sztuka walki oparta na szacunku, pokorze i dążeniu
              do doskonałości.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center mx-auto py-16 sm:flex-row flex-col">
          <div className="mx-8 mt-8">
            ...
            <p className="text-justify flex-grow sm:text-left mt-6 sm:mt-0">
              Judo to japońska sztuka walki skoncentrowana na rzutach, chwytach
              i dźwigniach. Styl walki w judo opiera się na wykorzystaniu siły i
              równowagi przeciwnika przeciwko niemu samemu. Zamiast uderzeń,
              judocy dążą do obalenia lub unieruchomienia rywala. Kluczową
              zasadą jest „ustępowanie, by zwyciężyć” (ju yoku go o seisu).
              Trening obejmuje naukę padów, rzutów oraz walki w parterze. Judo
              rozwija zwinność, siłę, wytrzymałość i precyzję. Walki odbywają
              się w kontrolowanych warunkach, co pozwala bezpiecznie stosować
              skuteczne techniki. To nie tylko sport, ale także filozofia oparta
              na szacunku, samodoskonaleniu i dyscyplinie.
            </p>
          </div>
        ...
        <div className="flex items-center mx-auto sm:flex-row flex-col py-16">
          ...
          <div className="mx-8 mt-8">
            ...
            <p className="text-justify flex-grow sm:text-left mt-6 sm:mt-0">
              ...
              obejmujących różne partie ciała, takie jak nogi, plecy, barki czy
              biodra. W trakcie zajęć stosuje się zarówno rozciąganie
