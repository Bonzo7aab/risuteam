        ...
        <div className="max-w-2xl">
              ...
              <div className="grow">
                <div className="flex items-center justify-between gap-x-2">
                  <div>
                    ...
                    <div className="hs-tooltip [--trigger:hover] [--placement:bottom] inline-block">
                      <div className="block cursor-pointer hs-tooltip-toggle sm:mb-1 text-start">
                        ...
                        {/* Dropdown Card */}
                        <div
                          className="absolute z-10 invisible inline-block max-w-xs transition-opacity bg-gray-900 divide-y divide-gray-700 shadow-lg opacity-0 cursor-default hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible rounded-xl"
                          role="tooltip"
                        >
                          {/* Body */}
                          <div className="p-4 sm:p-5">
                            <div className="flex w-full mb-2 sm:items-center gap-x-5 sm:gap-x-3">
                              <div className="shrink-0">
                                <img
                    ...
                    <ul className="text-xs text-gray-500">
                      <li className="relative inline-block pe-6 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-2 before:-translate-y-1/2 before:size-1 before:bg-gray-300 before:rounded-full">
                        Jan 18
                      </li>
                      <li className="relative inline-block pe-6 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-2 before:-translate-y-1/2 before:size-1 before:bg-gray-300 before:rounded-full">
                        8 min read
                  ...
                  <div>
                    <button
                      type="button"
                      className="py-1.5 px-2.5 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                    >
                      <svg
                        className="size-3.5"
                        xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="space-y-5 md:space-y-8">
            ...
            <p className="text-lg text-gray-800">
              ...
              <a
                className="font-medium text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline"
                href="#"
              >
            ...
            <ul className="space-y-5 text-lg text-gray-800 list-disc list-outside ps-5">
              <li className="ps-2">
        ...
        <div className="inline-block px-4 py-3 bg-white rounded-full shadow-md">
          <div className="flex items-center gap-x-1.5">
            ...
            <div className="inline-block hs-tooltip">
              <button
                type="button"
                className="flex items-center text-sm text-gray-500 hs-tooltip-toggle gap-x-2 hover:text-gray-800 focus:outline-hidden focus:text-gray-800"
              >
                <svg
                ...
                875
                <span
                  className="absolute z-10 invisible inline-block px-2 py-1 text-xs font-medium text-white transition-opacity bg-gray-900 rounded-md opacity-0 hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible shadow-2xs"
                  role="tooltip"
                >
                  Like
                </span>
            ...
            <div className="block h-3 mx-3 border-gray-300 border-e"></div>
            ...
            <div className="relative inline-flex hs-dropdown">
              <button
                ...
                type="button"
                className="flex items-center text-sm text-gray-500 gap-x-2 hover:text-gray-800 focus:outline-hidden focus:text-gray-800"
                aria-haspopup="menu"
                aria-expanded="false"
                aria-label="Dropdown"
              >
              ...
              >
                <a
                  className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-400 hover:bg-white/10 focus:outline-hidden focus:bg-white/10"
                  href="#"
                >
                  <svg
                    className="shrink-0 size-4"
